 ...
 *       &lt;sequence>
 *         &lt;element name="info" type="{urn:gf-scoring-verification:types}VerificationInfo" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Verification {
    ...
    protected List<VerificationInfo> info;
     ...
     * 
     */
    public List<VerificationInfo> getInfo() {
        if (info == null) {
            info = new ArrayList<VerificationInfo>();
        }
        return this.info;
    }

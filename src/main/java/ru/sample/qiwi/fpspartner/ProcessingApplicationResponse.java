/**
 * ProcessingApplicationResponse.java
 *
...
/**
 *  ProcessingApplicationResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ProcessingApplicationResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://example.org/FPSPartner",
            "processingApplicationResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":processingApplicationResponse",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "processingApplicationResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ProcessingApplicationResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ProcessingApplicationResponse object = new ProcessingApplicationResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"processingApplicationResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ProcessingApplicationResponse) ru.sample.qiwi.fpspartner.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

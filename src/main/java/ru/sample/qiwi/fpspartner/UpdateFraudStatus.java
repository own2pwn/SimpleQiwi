...
/**
 *  UpdateFraudStatus bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class UpdateFraudStatus implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://example.org/FPSPartner",
            "updateFraudStatus", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":updateFraudStatus", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "updateFraudStatus", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static UpdateFraudStatus parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UpdateFraudStatus object = new UpdateFraudStatus();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"updateFraudStatus".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (UpdateFraudStatus) ru.sample.qiwi.fpspartner.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

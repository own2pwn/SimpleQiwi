/**
 * UpdateFraudStatusResponse.java
 *
...
/**
 *  UpdateFraudStatusResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class UpdateFraudStatusResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://example.org/FPSPartner",
            "updateFraudStatusResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":updateFraudStatusResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "updateFraudStatusResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static UpdateFraudStatusResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UpdateFraudStatusResponse object = new UpdateFraudStatusResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"updateFraudStatusResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (UpdateFraudStatusResponse) ru.sample.qiwi.fpspartner.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

...
/**
 *  UpdateCreditStatus bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class UpdateCreditStatus implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://example.org/FPSPartner",
            "updateCreditStatus", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":updateCreditStatus", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "updateCreditStatus", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static UpdateCreditStatus parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UpdateCreditStatus object = new UpdateCreditStatus();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"updateCreditStatus".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (UpdateCreditStatus) ru.sample.qiwi.fpspartner.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

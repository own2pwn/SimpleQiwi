...
/**
 *  DoctypeType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DoctypeType implements org.apache.axis2.databinding.ADBBean {
    ...
    public static final java.lang.String _value17 = org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
            "99");
    public static final DoctypeType value1 = new DoctypeType(_value1, true);
    public static final DoctypeType value2 = new DoctypeType(_value2, true);
    public static final DoctypeType value3 = new DoctypeType(_value3, true);
    public static final DoctypeType value4 = new DoctypeType(_value4, true);
    public static final DoctypeType value5 = new DoctypeType(_value5, true);
    public static final DoctypeType value6 = new DoctypeType(_value6, true);
    public static final DoctypeType value7 = new DoctypeType(_value7, true);
    public static final DoctypeType value8 = new DoctypeType(_value8, true);
    public static final DoctypeType value9 = new DoctypeType(_value9, true);
    public static final DoctypeType value10 = new DoctypeType(_value10, true);
    public static final DoctypeType value11 = new DoctypeType(_value11, true);
    public static final DoctypeType value12 = new DoctypeType(_value12, true);
    public static final DoctypeType value13 = new DoctypeType(_value13, true);
    public static final DoctypeType value14 = new DoctypeType(_value14, true);
    public static final DoctypeType value15 = new DoctypeType(_value15, true);
    public static final DoctypeType value16 = new DoctypeType(_value16, true);
    public static final DoctypeType value17 = new DoctypeType(_value17, true);

    /**
     * field for DoctypeType
     */
    protected java.lang.String localDoctypeType;

    // Constructor
    protected DoctypeType(java.lang.String value, boolean isRegisterValue) {
        localDoctypeType = value;

        if (isRegisterValue) {
            _table_.put(localDoctypeType, this);
        }
    }

    public java.lang.String getValue() {
        return localDoctypeType;
    }
    ...
    public java.lang.String toString() {
        return localDoctypeType.toString();
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DoctypeType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DoctypeType", xmlWriter);
            }
        }

        if (localDoctypeType == null) {
            throw new org.apache.axis2.databinding.ADBException(
                "DoctypeType cannot be null !!");
        } else {
            xmlWriter.writeCharacters(localDoctypeType);
        }
    ...
    public static class Factory {
        ...
        public static DoctypeType fromValue(java.lang.String value)
            throws java.lang.IllegalArgumentException {
            DoctypeType enumeration = (DoctypeType) _table_.get(value);
        ...
        public static DoctypeType fromString(java.lang.String value,
        ...
        public static DoctypeType fromString(
            ...
            if (content.indexOf(":") > -1) {
                ...
                return DoctypeType.Factory.fromString(content, namespaceUri);
            } else {
                return DoctypeType.Factory.fromString(content, "");
            }
        }
         ...
         */
        public static DoctypeType parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            DoctypeType object = null;
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement() || reader.hasText()) {
                        ...
                        if (content.indexOf(":") > 0) {
                            ...
                            object = DoctypeType.Factory.fromString(content,
                                    namespaceuri);
                        } else {

/**
 * UpdateCreditStatusResponse.java
 *
...
/**
 *  UpdateCreditStatusResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class UpdateCreditStatusResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://example.org/FPSPartner",
            "updateCreditStatusResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":updateCreditStatusResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "updateCreditStatusResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static UpdateCreditStatusResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UpdateCreditStatusResponse object = new UpdateCreditStatusResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"updateCreditStatusResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (UpdateCreditStatusResponse) ru.sample.qiwi.fpspartner.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

...
/**
 *  NewApplicationResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class NewApplicationResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://example.org/FPSPartner",
            "newApplicationResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":newApplicationResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "newApplicationResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static NewApplicationResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            NewApplicationResponse object = new NewApplicationResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"newApplicationResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (NewApplicationResponse) ru.sample.qiwi.fpspartner.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

/**
 * UpdateDefaultStatusResponse.java
 *
...
/**
 *  UpdateDefaultStatusResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class UpdateDefaultStatusResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://example.org/FPSPartner",
            "updateDefaultStatusResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":updateDefaultStatusResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "updateDefaultStatusResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static UpdateDefaultStatusResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UpdateDefaultStatusResponse object = new UpdateDefaultStatusResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"updateDefaultStatusResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (UpdateDefaultStatusResponse) ru.sample.qiwi.fpspartner.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

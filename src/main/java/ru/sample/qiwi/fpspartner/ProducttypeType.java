...
/**
 *  ProducttypeType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ProducttypeType implements org.apache.axis2.databinding.ADBBean {
    ...
    public static final java.lang.String _value23 = org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
            "99");
    public static final ProducttypeType value1 = new ProducttypeType(_value1,
            true);
    public static final ProducttypeType value2 = new ProducttypeType(_value2,
            true);
    public static final ProducttypeType value3 = new ProducttypeType(_value3,
            true);
    public static final ProducttypeType value4 = new ProducttypeType(_value4,
            true);
    public static final ProducttypeType value5 = new ProducttypeType(_value5,
            true);
    public static final ProducttypeType value6 = new ProducttypeType(_value6,
            true);
    public static final ProducttypeType value7 = new ProducttypeType(_value7,
            true);
    public static final ProducttypeType value8 = new ProducttypeType(_value8,
            true);
    public static final ProducttypeType value9 = new ProducttypeType(_value9,
            true);
    public static final ProducttypeType value10 = new ProducttypeType(_value10,
            true);
    public static final ProducttypeType value11 = new ProducttypeType(_value11,
            true);
    public static final ProducttypeType value12 = new ProducttypeType(_value12,
            true);
    public static final ProducttypeType value13 = new ProducttypeType(_value13,
            true);
    public static final ProducttypeType value14 = new ProducttypeType(_value14,
            true);
    public static final ProducttypeType value15 = new ProducttypeType(_value15,
            true);
    public static final ProducttypeType value16 = new ProducttypeType(_value16,
            true);
    public static final ProducttypeType value17 = new ProducttypeType(_value17,
            true);
    public static final ProducttypeType value18 = new ProducttypeType(_value18,
            true);
    public static final ProducttypeType value19 = new ProducttypeType(_value19,
            true);
    public static final ProducttypeType value20 = new ProducttypeType(_value20,
            true);
    public static final ProducttypeType value21 = new ProducttypeType(_value21,
            true);
    public static final ProducttypeType value22 = new ProducttypeType(_value22,
            true);
    public static final ProducttypeType value23 = new ProducttypeType(_value23,
            true);

    /**
     * field for ProducttypeType
     */
    protected java.lang.String localProducttypeType;

    // Constructor
    protected ProducttypeType(java.lang.String value, boolean isRegisterValue) {
        localProducttypeType = value;

        if (isRegisterValue) {
            _table_.put(localProducttypeType, this);
        }
    }

    public java.lang.String getValue() {
        return localProducttypeType;
    }
    ...
    public java.lang.String toString() {
        return localProducttypeType.toString();
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ProducttypeType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ProducttypeType", xmlWriter);
            }
        }

        if (localProducttypeType == null) {
            throw new org.apache.axis2.databinding.ADBException(
                "ProducttypeType cannot be null !!");
        } else {
            xmlWriter.writeCharacters(localProducttypeType);
        }
    ...
    public static class Factory {
        ...
        public static ProducttypeType fromValue(java.lang.String value)
            ...
            ProducttypeType enumeration = (ProducttypeType) _table_.get(value);
        ...
        public static ProducttypeType fromString(
            ...
            if (content.indexOf(":") > -1) {
                ...
                return ProducttypeType.Factory.fromString(content, namespaceUri);
            } else {
                return ProducttypeType.Factory.fromString(content, "");
            }
        }
         ...
         */
        public static ProducttypeType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ProducttypeType object = null;
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement() || reader.hasText()) {
                        ...
                        if (content.indexOf(":") > 0) {
                            ...
                            object = ProducttypeType.Factory.fromString(content,
                                    namespaceuri);
                        } else {

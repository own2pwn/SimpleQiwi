...
/**
 *  ProcessingApplication bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ProcessingApplication implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://example.org/FPSPartner",
            "processingApplication", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":processingApplication", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "processingApplication", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ProcessingApplication parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ProcessingApplication object = new ProcessingApplication();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"processingApplication".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ProcessingApplication) ru.sample.qiwi.fpspartner.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

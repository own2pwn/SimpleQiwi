/**
 * DeleteApplicationResponse.java
 *
...
/**
 *  DeleteApplicationResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DeleteApplicationResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://example.org/FPSPartner",
            "deleteApplicationResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":deleteApplicationResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "deleteApplicationResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DeleteApplicationResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DeleteApplicationResponse object = new DeleteApplicationResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"deleteApplicationResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (DeleteApplicationResponse) ru.sample.qiwi.fpspartner.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
